    ...
    <div class="page-header page-header-light">
        ...
        <div class="page-header-content header-elements-md-inline">
            ...
            <div class="header-elements d-none">
                <a href="{{route('transfer.provincialarea.create')}}" class="btn btn-labeled btn-labeled-right bg-primary">เพิ่มการโอน <b><i class="icon-plus3"></i></b></a>
            </div>
        </div>
                                                ...
                                                @foreach ($transfertransactions as $key => $transfertransaction)
                                                    @if ($transfertransaction->allocationtransaction->subsidycategory->id == $projectallocation->subsidy_category_id)
                                                        <tr>   
                                                            ...
                                                            <td> {{$transfertransaction->allocationtransaction->provincialsubareaeducation->name}} </td>                                                            
