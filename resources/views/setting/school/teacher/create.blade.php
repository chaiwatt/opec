	...
	<div class="page-header page-header-light">
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">เพิ่มครู</span></h4>
		...
		<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
			<div class="d-flex">
				<div class="breadcrumb">
					...
					<span class="breadcrumb-item ">ครู</span>
					<span class="breadcrumb-item ">เพิ่มครู</span>
				</div>
				<a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
			</div>
		</div>
	...
	<div class="content">
		...
		<div class="card">
			<div class="card-header header-elements-inline">
				<h6 class="card-title">เพิ่มครู</h6>
			...
			<div class="card-body">
				<form method="POST" action="" enctype="multipart/form-data">
					...
					<ul class="nav nav-tabs nav-tabs-highlight">
						<li class="nav-item"><a href="#left-icon-teacher" class="nav-link active" data-toggle="tab"><i class="icon-menu7 mr-2"></i> ข้อมูลครู</a></li>
						<li class="nav-item"><a href="#left-icon-license" class="nav-link" data-toggle="tab"><i class="icon-bookmark mr-2"></i> ข้อมูลการศึกษา</a></li>			
						<li class="nav-item"><a href="#left-icon-tax" class="nav-link" data-toggle="tab"><i class="icon-clipboard3 mr-2"></i> ข้อมูลภาษี</a></li>
					</ul>
					<div class="tab-content">
						<input id="hidden_amphur" type="text" value="" hidden>
						<input id="hidden_tambol" type="text" value="" hidden>
						<div class="tab-pane fade show active" id="left-icon-teacher">
							<div class="row">									
								<div class="col-md-12">																		
									<div class="row">
										<div class="col-md-4">
						...
						<div class="tab-pane fade" id="left-icon-license">
							<div class="row">	
								<div class="col-md-12">	
									<div class="row">
										<div class="col-md-12">	
