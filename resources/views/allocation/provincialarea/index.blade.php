    ...
    <div class="page-header page-header-light">
        ...
        <div class="page-header-content header-elements-md-inline">
            ...
            <div class="header-elements d-none">
                <a href="{{route('allocation.provincialarea.create')}}" class="btn btn-labeled btn-labeled-right bg-primary">เพิ่มการจัดสรร <b><i class="icon-plus3"></i></b></a>
            </div>
        </div>
                                                ...
                                                @foreach ($allocationtransactions as $key => $allocationtransaction)
                                                    @if ($allocationtransaction->subsidy_category_id == $projectallocation->subsidy_category_id)
                                                        <tr>   
                                                            ...
                                                            <td> {{$allocationtransaction->school->name}} </td>                                                            
